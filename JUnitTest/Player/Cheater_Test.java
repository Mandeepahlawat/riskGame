...
public class Cheater_Test {

	/**
	 * This is the JUnit Test cases for Cheater player class. this implements all
	...
	/**
	 * test class testBefore that runs before each methods within this class
	 */
	@Before
	...
	/**
	 * test class testCalculateReinforcementArmiesContinentCapture this test the
	 * calculateReinforcementArmies method condition if continent capture
	 */
	@Test
	public void testCalculateReinforcementArmiesContinentCapture() {
		...
		Cheater playerStrategy = new Cheater(player);

		// Main.activeMap.continents.get(0).territories.get(0).
		System.out.println(playerStrategy.calculateReinforcementArmies());
		assertTrue(playerStrategy.calculateReinforcementArmies() == 5);  
	}

	/**
	 * test class testCalculateReinforcementArmiesContinentCapture this test the
	 * calculateReinforcementArmies method condition if no continent capture
	 */
	...
	public void testCalculateReinforcementArmiesNoContinentCapture() {
		...
		// Main.activeMap.continents.get(0).territories.get(0).
		System.out.println(playerStrategy.calculateReinforcementArmies());
		assertTrue(playerStrategy.calculateReinforcementArmies() == 0);  
	}

	/**
	 * test class testPlaceReinforcements this test the placeReinforcements method
	 */
	...
	public void testPlaceReinforcements() {
		...
		assertTrue(player.assignedTerritories.get(0).numberOfArmies == 10); // altready 5 and now added 3
	}

	/**
	 * test class testFortification this test the random fortification method
	 */
	@Test
