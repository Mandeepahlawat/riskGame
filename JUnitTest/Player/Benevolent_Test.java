...
/**
 * This is the JUnit Test cases for Benevolent player class. this implements all
...
public class Benevolent_Test {
	...
	public void testCalculateReinforcementArmiesContinentCapture() {
		...
		Benevolent playerStrategy = new Benevolent(player);
